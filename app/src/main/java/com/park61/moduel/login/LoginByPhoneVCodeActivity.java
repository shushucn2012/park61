...
public class LoginByPhoneVCodeActivity extends BaseActivity {
    ...
    protected void asyncGetRegVcode() {
        String wholeUrl = AppUrl.host + AppUrl.sendLoginVerifyCode;
     ...
     * 验证码登录
     */
    protected void asyncLoginByVerifyCode() {
        String wholeUrl = AppUrl.host + AppUrl.loginByVerifyCode;
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("mobile", userMobile);
