...
import com.park61.moduel.sales.adapter.OverseasGoodsListAdapter;
 ...
 * 海外优品界面
 */
public class OverseasGoodsActivity extends BaseActivity {
    ...
    public void setLayout() {
        setContentView(R.layout.activity_overseas_goods);
    }
    ...
    public void initData() {
        ...
        mAdapter = new OverseasGoodsListAdapter(mContext, dataList);
