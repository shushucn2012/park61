...
public class MPagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int tabBackgroundResId = R.drawable.background_select_tab;
	...
	public MPagerSlidingTabStrip(Context context, AttributeSet attrs,
		...
		selectedTabTextColor = a.getColor(2, tabTextColor);
		a.recycle();
	...
	private void addTextTab(final int position, String title) {
		...
		tab.setLayoutParams(new LayoutParams(75, 48));
//		tab.setSingleLine();
		addTab(position, tab);
	}
