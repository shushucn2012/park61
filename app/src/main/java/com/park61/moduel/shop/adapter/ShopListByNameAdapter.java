...
public class ShopListByNameAdapter extends BaseAdapter {

	private List<ActNShopBean> mList;
	private Context mContext;
	private LayoutInflater factory;

	public ShopListByNameAdapter(Context _context, List<ActNShopBean> _list) {
		this.mList = _list;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = factory
					.inflate(R.layout.shop_list_by_name_item, null);
