...
import com.park61.R;
import com.park61.moduel.firsthead.fragment.FragmentMyPublish;

/**
 * Created by shubei on 2017/6/16.
 */

public class MyPublishListActivity extends BaseActivity implements CompoundButton.OnCheckedChangeListener {
    ...
    final int[] BUTION_IDS = {R.id.rb_topic, R.id.rb_tv};
    ...
    public class MyPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            FragmentMyPublish fragment = new FragmentMyPublish();
