...
/**
 * 商品已寄出等待商家签收的界面（退货状态：2、提交货品）
 * @author Lucia
 */
public class WaitForMerchanSignActivity extends BaseActivity implements OnClickListener {

	private TextView type_value, reason_value, refund_amount, regoods_amount,
	detail_value,sales_after_number_value,request_time_value,regoods_express_value,express_number_value;
	...
	public void setLayout() {
		setContentView(R.layout.activity_sales_after_regoods);
