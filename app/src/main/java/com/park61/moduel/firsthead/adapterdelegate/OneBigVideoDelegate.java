 ...
 */
public class OneBigVideoDelegate implements ItemViewDelegate<FirstHeadBean> {

    private Context mContext;

    public OneBigVideoDelegate(Context context) {
        this.mContext = context;
    }

    @Override
    public int getItemViewLayoutId() {
        return R.layout.firsthead_one_big_video;
    }
