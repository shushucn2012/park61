 ...
 * @author Lucia
 */
public class MyAddressManageEditActivity extends BaseActivity implements
    ...
    private TextView tv_province, tv_city, tv_county, delete_tv, tv_town;
    ...
    private void updateAddress() {
        String wholeUrl = AppUrl.host + AppUrl.UPDATE_ADDR;
    ...
    private void asyncDetailAddress() {
        String wholeUrl = AppUrl.host + AppUrl.GET_DETAIL_ADDR;
    ...
    BaseRequestListener listener = new JsonRequestListener() {
        ...
        public void onSuccess(int requestId, String url, JSONObject jsonResult) {
            dismissDialog();
            AddressDetailItem b = gson.fromJson(jsonResult.toString(),
                    AddressDetailItem.class);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_town:
                ...
                break;
            case R.id.delete_tv:
                dDialog.showDialog("提示", "您确定要删除吗？", "取消", "确定",
                        new OnClickListener() {
    ...
    BaseRequestListener provinceListener = new JsonRequestListener() {
        ...
        public void onSuccess(int requestId, String url, JSONObject jsonResult) {
            ...
            SelecProvinceDialog dialog = new SelecProvinceDialog(mContext,
                    mList);
            dialog.showDialog();
            dialog.setOnProvinceSelectLsner(MyAddressManageEditActivity.this);
    ...
    BaseRequestListener cityListener = new JsonRequestListener() {
        ...
        public void onSuccess(int requestId, String url, JSONObject jsonResult) {
            ...
            dialog.showDialog();
            dialog.setOnCitySelectLsner(MyAddressManageEditActivity.this);
        }
    };
    ...
    BaseRequestListener countyListener = new JsonRequestListener() {
        ...
        public void onSuccess(int requestId, String url, JSONObject jsonResult) {
            ...
            dialog.showDialog();
            dialog.setOnCountySelectLsner(MyAddressManageEditActivity.this);
        }
    };
    /**
     * 通过区域id获取对应乡镇名
    ...
    BaseRequestListener townListener = new JsonRequestListener() {
        ...
        public void onSuccess(int requestId, String url, JSONObject jsonResult) {
            ...
            dialog.showDialog();
            dialog.setOnTownSelectLsner(MyAddressManageEditActivity.this);// 选择乡镇点击事件
        }
    };
