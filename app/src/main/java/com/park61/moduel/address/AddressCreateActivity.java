 ...
 * @author Lucia
 */
public class AddressCreateActivity extends BaseActivity implements
    ...
    private TextView tv_province, tv_city, tv_county, tv_town, tv_province_details;
    private ImageView img_chioce;
    private View defauit_address_area, area_rl;
    ...
    public Integer ISDEFAULT = 0; // 是否默认收货地址 0-否 1-是
...
//		goodReceiverCityId = Long.parseLong(GlobalParam.chooseCityCode);
    ...
    public void initListener() {
        ...
        defauit_address_area.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (ISDEFAULT == 0) {//未选择
                    img_chioce.setImageResource(R.drawable.icon_circle_gou_chosen);
                    ISDEFAULT = 1;
                } else {//选择
                    img_chioce.setImageResource(R.drawable.icon_circle_gou_default);
                    ISDEFAULT = 0;
                }
            }
        });
    ...
    protected boolean validateAddress() {
        goodReceiverName = name_value.getText().toString().replace("请输入收货人姓名", "");
        goodReceiverMobile = number_value.getText().toString().replace("请输入手机号码", "");
        goodReceiverAddress = address_detail.getText().toString().replace("请输入您的详细地址", "");
        goodReceiverProvinceName = tv_province.getText().toString().replace("省份", "");
        goodReceiverCityName = tv_city.getText().toString().replace("城市", "");
        goodReceiverCountyName = tv_county.getText().toString().replace("区域", "");
    ...
    BaseRequestListener countyListener = new JsonRequestListener() {
        ...
        public void onSuccess(int requestId, String url, JSONObject jsonResult) {
            ...
            goodReceiverProvinceId = parentJob.optLong("goodReceiverProvinceId");
            ...
            dialog.showDialog();
            dialog.setOnCountySelectLsner(AddressCreateActivity.this);// 选择区域点击事件
        }
    };
    ...
    BaseRequestListener townListener = new JsonRequestListener() {
        ...
        public void onSuccess(int requestId, String url, JSONObject jsonResult) {
            ...
            dialog.showDialog();
            dialog.setOnTownSelectLsner(AddressCreateActivity.this);// 选择乡镇点击事件
        }
    };
    ...
    BaseRequestListener cityListener = new JsonRequestListener() {
        ...
        public void onSuccess(int requestId, String url, JSONObject jsonResult) {
            ...
            dialog.showDialog();
            dialog.setOnCitySelectLsner(AddressCreateActivity.this);// 选择城市点击事件
        }
    };
    ...
    BaseRequestListener provinceListener = new JsonRequestListener() {
        ...
        public void onSuccess(int requestId, String url, JSONObject jsonResult) {
            ...
            dialog.showDialog();
            dialog.setOnProvinceSelectLsner(AddressCreateActivity.this);// 选择省份点击事件
        }
    };
    ...
    private void asyncAddAddress() {
        String wholeUrl = AppUrl.NEWHOST_HEAD + AppUrl.addAddressByUserId;
