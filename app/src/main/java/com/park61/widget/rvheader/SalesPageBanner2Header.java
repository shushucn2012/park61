 ...
 * 商城主页banner模块
 */
public class SalesPageBanner2Header extends RelativeLayout {

    private List<BannerItem> bannerlList;
    private  MyBanner mp;

    public SalesPageBanner2Header(Context context, List<BannerItem> _bannerlList) {
        super(context);
        this.bannerlList = _bannerlList;
        init(context);
    }

    public SalesPageBanner2Header(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public SalesPageBanner2Header(Context context, AttributeSet attrs, int defStyleAttr) {
