...
//            bannerList.add(item);
        ...
        for (int i = 0; i < bannerList.size(); i++) {
            ...
            ImageManager.getInstance().displayImg(img_big_photo, bannerList.get(i).getLinkPic(), R.drawable.img_default_h);
            views.add(viewItem);
        }
        if (picNum > 1) {
    ...
    private class OnBannerItemClickLsner implements OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if("top".equals(category)){
                ...
                MobclickAgent.onEventValue(context, "ClickTopBanner",map,0);
                ...
                MobclickAgent.onEventValue(context, "ClickMiddleBanner1",map,0);
            }
