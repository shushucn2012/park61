...
public class PhotoView extends ImageView {
	...
	public void loadImageUrl(String imgUrl, int defaultDrawableId) {
//		String url = FileCacheUtils.getFileName(imgUrl);
//		AppBean _AppBean = ((IApplication) mContext.getApplicationContext()).getAppBean();
//		if (FileCacheUtils.checkFileByNameExists(_AppBean.getSavePath() + _AppBean.mDownImg + url)) {
//			url = "file:///" + _AppBean.savePath + _AppBean.mDownImg + url;
//		} else if (imgUrl.startsWith(URLs.IMAGE_HTTP)) {
//			url = imgUrl;
//		} else {
//			url = URLs.IMAGE_HTTP + url;
//		}
//
//		url = url.replace("thumb_", "");
//		DisplayTypeUtils.displayImage(this, url, new DisplayTypeUtils().getBig(defaultDrawableId), pApplication);
		
		ImageManager.getInstance().displayImg(this, imgUrl,defaultDrawableId);
		initBase();
	}
	...
	private class Transform implements Runnable {
		...
		void withClip(float fromX, float fromY, float deltaX, float deltaY, int d, ClipCalculate c) {
			mClipScroller.startScroll((int) (fromX * 10000), (int) (fromY * 10000), (int) (deltaX * 10000),
					(int) (deltaY * 10000), d);
			C = c;
		}
	...
	/**
	 * ��PhotoView�ڲ���û��ͼƬ��ʱ��ͬ����Ե��ø÷���
	 * <p>
	 * </p>
	 * ��ʱ�����Ქ�Ŷ���������PhotoView����ͼƬ����Զ����Ŷ�����
	 * <p>
	 * </p>
	 * ���ȴ�ʱ���Ҳû�и�ؼ�����ͼƬ�������Ըö�������Ҫ�ٴβ��Ŷ�������Ҫ���µ��ø÷���
	 * (�ȴ��ʱ��Ĭ��500���룬����ͨ��setMaxAnimFromWaiteTime(int)�������ȴ�ʱ��)
	 */
