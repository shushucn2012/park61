...
/**
 * Created by shubei on 2017/6/7.
 */

public class HeadAndFootAdapter<T> extends MultiItemTypeAdapter<T> {
    ...
    private com.github.jdsjlzx.interfaces.OnItemClickListener mOnItemClickListener;
    ...
    private LRecyclerViewAdapter.SpanSizeLookup mSpanSizeLookup;


    public HeadAndFootAdapter(RecyclerView.Adapter innerAdapter) {
    ...
    @Override
    public com.park61.widget.myrv.base.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_REFRESH_HEADER) {
            return new com.park61.widget.myrv.base.ViewHolder(mRefreshHeader.getHeaderView());
        } else if (isHeaderType(viewType)) {
            return new com.park61.widget.myrv.base.ViewHolder(getHeaderViewByType(viewType));
        } else if (viewType == TYPE_FOOTER_VIEW) {
            return new com.park61.widget.myrv.base.ViewHolder(mFooterViews.get(0));
        }
        return (com.park61.widget.myrv.base.ViewHolder)mInnerAdapter.onCreateViewHolder(parent, viewType);
    }

    @Override
    public void onBindViewHolder(final com.park61.widget.myrv.base.ViewHolder holder, int position) {
    ...
    @Override
    public void onBindViewHolder(final com.park61.widget.myrv.base.ViewHolder holder, int position, List<Object> payloads) {
        if (payloads.isEmpty()) {
    ...
    @Override
    public void onViewAttachedToWindow(com.park61.widget.myrv.base.ViewHolder holder) {
    ...
    @Override
    public void onViewDetachedFromWindow(com.park61.widget.myrv.base.ViewHolder holder) {
        mInnerAdapter.onViewDetachedFromWindow(holder);
    }

    @Override
    public void onViewRecycled(com.park61.widget.myrv.base.ViewHolder holder) {
    ...
    public void setOnItemClickListener(com.github.jdsjlzx.interfaces.OnItemClickListener itemClickListener) {
