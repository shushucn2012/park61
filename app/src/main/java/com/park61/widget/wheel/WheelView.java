...
public class WheelView extends View {
	...
	private static final int VALUE_TEXT_COLOR = 0xFF000000;// ���ñ�ѡ��ʱ���������ɫ
...
//			0x00AAAAAA, 0x00AAAAAA };
	 ...
	 private static final int[] SHADOWS_COLORS = new int[] {0xeeffffff, 0x99ffffff,
		 0x33ffffff};
	
	/** Top and bottom shadows colors */
	private static final int[] MSHADOWS_COLORS = new int[] { 0x00111111,
			0x00AAAAAA, 0x00AAAAAA };
