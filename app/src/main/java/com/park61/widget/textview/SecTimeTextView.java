 ...
 * @author super
 */
public class SecTimeTextView extends TextView implements Runnable {
    ...
    public SecTimeTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mPaint = new Paint();
    ...
    public SecTimeTextView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public SecTimeTextView(Context context) {
        super(context);
    }
    ...
    private void ComputeTime() {
        ...
        if (msecond == 0l && mmin == 0l && mhour == 0l) {// 为0的时候停止
            setRun(false);
        }
    }
